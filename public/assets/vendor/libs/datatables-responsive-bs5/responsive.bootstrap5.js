                  ...
                  var l,
                    ...
                    b = function (n, i) {
                      ...
                      for (r = 0, o = i.length; r < o; r++)
                        if (((y = i[r]), Array.isArray(y))) b(n, y);
                        else {
                          switch (((l = ""), (c = ""), y)) {
                            case "ellipsis":
                              (l = "&#x2026;"), (c = "disabled");
                          ...
                          l &&
                            ((u = e("<li>", {
                              ...
                              .appendTo(n)),
                            t.oApi._fnBindAction(u, { action: y }, g),
                            v++);
                        }
                    };
                  try {
              ...
              e.extend(s.prototype, {
                  ...
                  var t = this,
                    ...
                    a = function (e, i, r, a) {
                      ...
                      if (r) {
                        if ("max-" === r)
                          for (
                            d = t._find(i).width, l = 0, c = n.length;
                            l < c;
                            l++
                          )
                ...
                _detailsInit: function () {
                  var t = this,
                    ...
                    r = this.c.details;
                  "inline" === r.type &&
                    (r.target = "td.dtr-control, th.dtr-control"),
                  ...
                  o
                    ...
                    h &&
                      ...
                      0 === o.page.info().recordsDisplay &&
                        e("td", o.table().body()).eq(0).attr("colspan", m)),
                    s._controlClass();
                },
                  ...
                  if (
                    ...
                    e("<tr/>").append(d).appendTo(r),
                      "inline" === this.c.details.type &&
                        e(i).addClass("dtr-inline collapsed"),
