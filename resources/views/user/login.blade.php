        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-md-8 col-lg-6 col-xl-6 align-items-center position-relative" style="background-image: url(/assets/img/backgrounds/person_vote.jpg); background-size: cover; z-index:-40;">
                <div class="position-absolute top-0 start-0 end-0 bottom-0 " style="background-color: rgba(0, 0, 0, 0.7); z-index:-20;">
                    <div class="p-5 countdown-container" style="margin-top:110px;">
                        <center>
                            ...
                            <div class="countdown-text">Election ends in</div>
                        </center>
                    </div>
                </div>
            ...
            <div class="d-flex col-12 col-lg-6 col-md-6 col-xl-6 align-items-center authentication-bg p-sm-5 p-4" style="background-color:#F5F7F8 !important;">
                <div class="w-px-400 mx-auto">
                    ...
                    <form id="LoginForm" class="mb-3" method="POST">
                        <h5 class="mt-2  text-center" style="color:#128C7E; font-family: 'Trajax', sans-serif; font-weight:700;">Welcome Back, Signin to Vote</h5>
                        <center>
                            <span class="text-center mt-0" style="color:#128C7E; font-family: 'Poppins', sans-serif; font-weight:500;">Enter Your Matric Number and Date of Birth</span>
                        </center>
                        <div class="mb-3 mt-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="user_matric" name="matric" required class="form-control py-3 border-0 " placeholder="Enter Your Matric Number" autofocus />
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="dob" id="user_dob" required class="form-control py-3 border-0 " placeholder="Ex: 1999-05-15" autofocus />
                            </div>
